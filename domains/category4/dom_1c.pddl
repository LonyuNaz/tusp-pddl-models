...
(:action switch_a
    ...
    :precondition (and 
        (potential_connection ?ra1 ?rb)
        (potential_connection ?ra2 ?rb)
        (connected ?ra1 ?rb)
    )
    :effect (and 
        (not (connected ?ra1 ?rb))
        (connected ?ra2 ?rb)
    )
)
...
(:action switch_b
    ...
    :precondition (and 
        ; statics
        (potential_connection ?ra ?rb1)
        (potential_connection ?ra ?rb2)
        (connected ?ra ?rb1)
    )
    :effect (and 
        (not (connected ?ra ?rb1))
        (connected ?ra ?rb2)
    )
)
