...
(:durative-action enter_aside
    ...
    :condition (and 
        ...
        (over all (<= (aside_distance ?t)(astack_distance ?r)))
    )
    :effect (and 
        (at start (not (idle ?d)))
        (at end (operated ?t))
...
(:durative-action enter_bside
    ...
    :condition (and 
        ...
        ; other
        (over all (train_at ?t ?r))
        (over all (>= (+ (train_length ?t)(aside_distance ?t)) (bstack_distance ?r)))
    )
    :effect (and 
        (at start (not (idle ?d)))
        (at end (operated ?t))
